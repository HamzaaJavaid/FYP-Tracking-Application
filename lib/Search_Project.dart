...
class _Search_projectState extends State<Search_project> {
  ...
  String first_comment = "_";
  String second_comment = "_";
  String third_comment = "_";
  String final_comment = "_";
                   ...
                   ListView.builder(
                       ...
                       itemBuilder: (context , index){
                         ...
                         String description  = snapshot.data!.docs[index]['Description'];
                          ...
                          first_comment = snapshot.data!.docs[index]['1st Progress Report Comments'];
                          second_comment  = snapshot.data!.docs[index]['2nd Progress Report Comments'];


                          third_comment = snapshot.data!.docs[index]['3rd Progress Report Comments'];
                          final_comment  = snapshot.data!.docs[index]['Final Viva'];
                         ...
                         if(search_converse_controller.text.isEmpty){
                           ...
                           return Column(
                             children: [
                               ...
                               Text('Final Viva Remarks :- $final_comment',style: TextStyle(fontWeight: FontWeight.bold),),

                               MaterialButton(onPressed : ()async{


                                 print("Wait");
                                 await firestor.collection('Projects').doc(snapshot.data!.docs[index]['id'].toString()).delete().then((value) => print("Deleted"))
                                 ...
                                 child: Text('Delete Project',style: TextStyle(
                                     fontSize: 20,
